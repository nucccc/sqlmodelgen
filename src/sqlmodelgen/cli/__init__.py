...
def main_cli(args: Iterable[str] | None = None):
    ...
    _act_on_args(parsed, list(args) if args else [], parser)
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        action='store_false',
        dest='header',
        help="Don't include a little `generated by: <command-line-arguments>` header to your files. Also a version-number.",
    )

    return parser


def _act_on_args(args: argparse.Namespace, argv: list[str], usage: str):
