"""
Shared verify helpers that ensure the Python API functions
and the CLI produce the same output for every backend.
"""
...
def _postres_cli(
    conn_string: str, rels: bool, schema_name: str = "public", short_arg: bool = False
) -> str:
